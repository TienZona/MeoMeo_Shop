<?php
    ...
    function renderProduct($listProduct){
        if($listProduct){
            foreach($listProduct as $product){
                ...
                <div class="product__item col-6 col-sm-6 col-md-4 col-lg-3 col-xg-3">
                    ...
                    <div class="product-detail-container p-3">
                        ...
                        <a href="../../views/product_detail/index.php?act=info&id='.$id_product.'" class="btn-card"><i class="fa-solid fa-bag-shopping icon"></i></a href="../../views/product_detail/index.php?act=info&id='.$id_product.'">
            ...
            echo '<img src="../../img/no-product-found.png" class="img-fluid rounded">';
        }
    }
