<div class="container" style="margin: 100px auto">
    <div class="row main">
        ...
        <form id="registerForm" class="form-horizontal" method="post" action="index.php?act=reg">
                ...
                <div class="form-group ">
                    <button type="submit" class="btn btn-primary btn-lg btn-block login-button btn-login">Đăng ký</button>
                </div>
                <div class="login-register mb-5">
                    <p class="fs-5">Bạn đã có tài khoản! <a href="/MeoMeo_Shop/views/login/index.php?act=login">Đăng nhập</a></p>
                    </div>
            </form>
        </div>
    </div>
