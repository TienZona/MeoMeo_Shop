    ...
    <div class="container pt-md-5">
        ...
        <div class="col-lg-4">
                ...
                <div class="d-flex flex-column align-items-center text-center">
                    <div class="profile-avatar">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <form id="form-upload" action="index.php?act=updateAvatar&id=<?= $id_user ?>" enctype="multipart/form-data" method="post">
                            <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <img id="avatar-upload" class="rounded-circle p-1 bg-primary" width="200" height="200" src="<?= $avatar ?>" alt="">
                    ...
                    <div class="mt-3">
                    <h4 id="profile-fullname"><?php echo $fullname ?></h4>
                    <p id="profile-birthdate" class="text-secondary"><?php echo substr($birthdate, 8, 2). '-' . substr($birthdate, 5, 2). '-' .substr($birthdate, 0, 4) ?></p>
                    <p id="profile-address" class=""><?php echo $address ?></p>
                    <p id="profile-telephone" class=""><?php echo $telephone ?></p>
            ...
            <div class="card">
                ...
                <form id="form-user" action="index.php?act=updateUser&id=<?=$id_user?>" enctype="multipart/form-data" method="post">
                    <table class="table-user">
                        <tbody>
                            <tr class="row mb-3 d-flex">
                                <td class="col-4 text-end"><b>Họ và tên:</b></td>
                                <td class="col-8"><input class="px-2 py-1" type="text" name="fullname" id="form-user__fullname" value="<?=$fullname?>"></td>
                            </tr>
                            <tr class="row mb-3">
                                <td class="col-4 text-end"><b>Email: </b></td>
                                <td  class="col-8"><input class="px-2 py-1" type="text" name="email" class="form-user__email" value="<?=$email?>"></td>
                            </tr>
                            <tr class="row mb-3">
                            ...
                            <tr class="row mb-3">
                                ...
                                <td class="col-8"><input class="px-2 py-1 user-birthdate" id="birthdate" name="birthdate" type="date" value="<?=$birthdate?>"></td>
                            </tr>
                            <tr class="row mb-3">
                                <td class="col-4 text-end"><b>Địa chỉ: </b></td>
                                <td class="col-8"><input class="px-2 py-1" id="address" name="address" type="text" value="<?=$address?>"></td>
                            </tr>
                            <tr class="row mb-3">
                                <td class="col-4 text-end"><b>SĐT: </b></td>
                                <td  class="col-8"><input class="px-2 py-1" id="telephone" name="telephone" type="tel" value="<?=$telephone?>"></td>
                            </tr>
                            <tr class="row mt-2">
                ...
                <form id="form-account" class="d-none" action="index.php?act=updatePW&id=<?= $id_user ?>" enctype="multipart/form-data" method="post">
                    <table class="table-user">
                        <tbody>
                            <tr class="row mb-3 d-flex">
