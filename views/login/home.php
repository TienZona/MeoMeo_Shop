<div class="container container-login" style="margin: 160px auto">
  ...
  <form id="loginForm" action="index.php?act=log" method="POST" style="padding: 0">
        <h1 class="header"><i class="fa fa-lock" aria-hidden="true"></i> Login</h1>
          ...
          <button type="submit" class="btn btn-primary btn-login"><span class="glyphicon glyphicon-off">Đăng nhập</span></button>
          ...
          <div class="footer-login">
            <p>Bạn không có tài khoản! <a href="/MeoMeo_Shop/views/register/index.php?act=reg">Đăng ký tại đây</a></p>
